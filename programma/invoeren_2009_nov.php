...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	foreach($velden as $waarde)
	{
		...
		$goepiemaand = '11'; //mm
		$goepiedag = '01'; //dd dag waarop ten laatste moet binnengeleverd worden (nog juist op tijd)
		$time = time();
		$nujaar = date('Y', $time);
		$numaand = date('m',$time);
		$nudag = date('d',$time);
...
if($count==0){
   ...
   $toon = true;
	...
	echo '<div class="error">Je hebt al een programma voor '.$datum[$i].' </div>';
	$toegevoegd = false;
}
  }
  }
...
<?php
		...
		?>	<tr>
				<th class="alt"><input type="hidden" name="txtDatum1" value="2009-11-15">15 november</th>
				<td class="alt"><textarea name="mtxProgramma1" cols="60" rows="5" ><?php echo $gegevens['mtxProgramma1']; ?></textarea></td>
			</tr>
			<tr>
				<th class="alt"> 22 november</th>
				<td class="alt">Christus Koning</td>
			<tr>
				<th><input type="hidden" name="txtDatum2" value="2009-11-29">29 November</th>
				<td ><textarea name="mtxProgramma2" cols="60" rows="5" ><?php echo $gegevens['mtxProgramma2']; ?></textarea></td>
			</tr>
			<tr>
				<th class="alt"><input type="hidden" name="txtDatum3" value="2009-12-06">6 december (sinterklaas)</th>
				<td class="alt"><textarea name="mtxProgramma3" cols="60" rows="5" ><?php echo $gegevens['mtxProgramma3']; ?></textarea></td>
			</tr>
			<tr>
				<th><input type="hidden" name="txtDatum4" value="2009-12-13">13 december (pannenkoekenslag)</th>
				<td ><textarea name="mtxProgramma4" cols="60" rows="5" ><?php echo $gegevens['mtxProgramma4']; ?></textarea></td>
			</tr>
            <tr>
				<th><input type="hidden" name="txtDatum5" value="2009-12-20">20 december</th>
				<td><textarea name="mtxProgramma5" cols="60" rows="5" ><?php echo $gegevens['mtxProgramma5']; ?></textarea></td>
			</tr>
			<tr>
				<th class="alt">27 december</th>
				<td class="alt">tussen kerst en nieuw</td>
			</tr>
			<tr>
				<th class="alt">03 januari</th>
				<td class="alt">bekomen van nieuwjaar</td>
			</tr>
                        <tr>
				<th><input type="hidden" name="txtDatum6" value="2010-01-10">10 januari (3 koningenzingen)</th>
				<td><textarea name="mtxProgramma6" cols="60" rows="5" ><?php echo $gegevens['mtxProgramma6']; ?></textarea></td>
			</tr>
			<tr>
				<th><input type="hidden" name="txtDatum7" value="2010-01-17">17 januari (aspiranten in leiding)</th>
				<td><textarea name="mtxProgramma7" cols="60" rows="5" ><?php echo $gegevens['mtxProgramma7']; ?></textarea></td>
			</tr>
			<tr>
				<th><input type="hidden" name="txtDatum8" value="2010-01-22">VRIJDAG 22 januari: AVONDCHIRO</th>
				<td><textarea name="mtxProgramma8" cols="60" rows="5" ><?php echo $gegevens['mtxProgramma8']; ?></textarea></td>
			</tr>
            <tr>
				<th><input type="hidden" name="txtDatum9" value="2010-01-31">31 januari (weekend muziekkapel)</th>
				<td><textarea name="mtxProgramma9" cols="60" rows="5" ><?php echo $gegevens['mtxProgramma9']; ?></textarea></td>
			</tr>
			<tr>
				<th><input type="hidden" name="txtDatum10" value="2010-02-07">7 februari(tikeas+ infoavond RSW)</th>
				<td><textarea name="mtxProgramma10" cols="60" rows="5" ><?php echo $gegevens['mtxProgramma10']; ?></textarea></td>
			</tr>
            <?php
