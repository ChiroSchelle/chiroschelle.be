...
/*
Plugin Name: Adminimize AANGEPAST
...
Author: Frank B&uuml;ltge (aangepast: Ben Bridts)
...
/**
 * ZOEK NAAR Ben Bridts voor de aangepaste regels
 **/
...
function _mw_adminimize_set_menu_option() {
	...
	if ($disabled_menu_['editor'] != '') {
		...
		if(is_array($menu)) // menu is niet altijd een array. Check toegevoegd door Ben Bridts 18/03/2011
		{
