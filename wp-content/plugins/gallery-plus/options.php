...
<?php /*
	  ...
	  */ ?>
		...
		<label for="tcr5"><input id="tcr5" type="radio" name="gallery_plus_titlecaption" value="download"<?php if ($gallery_plus_titlecaption == 'download') echo ' checked="checked"'; ?> />
		Download: image title + download link for title and an empty caption.</label><br />
