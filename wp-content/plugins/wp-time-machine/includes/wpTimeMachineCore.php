...
{ 
    ...
    echo '<script type="text/javascript"> if (!jQuery) google.load( "jquery","1.3.2" ); </script>                                                 ' . "\n";
    echo '<script type="text/javascript" src="' . wpcontent_url . '/plugins/wp-time-machine/javascript/jquery.form.js"></script>                  ' . "\n";
    echo '<script type="text/javascript" src="' . wpcontent_url . '/plugins/wp-time-machine/javascript/jquery.validate.js"></script>              ' . "\n";
    echo '<script type="text/javascript" src="' . wpcontent_url . '/plugins/wp-time-machine/javascript/jquery.fadeSliderToggle.js"></script>      ' . "\n";
    echo '<script type="text/javascript" src="' . wpcontent_url . '/plugins/wp-time-machine/javascript/jquery.simplemodal-1.3.5.min.js"></script> ' . "\n";
    echo '<!-- wpTimeMachine_head -->                                                                                                             ' . "\n";
