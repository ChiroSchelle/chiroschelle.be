...
Description: AANGEPAST DOOR BEN Security and sanity in file names while uploading. Once activate, please <a href="options-general.php?page=uploadplus">define your settings</a>. 
Author: Pixline
Version: 2.7
...
//toegevoegd door Ben Bridts	
			case "B":		$file_name = date('dHis').$sep.$file_name;			break;
		endswitch;
	return $file_name;
}
...
// 	"6" => 'unix timestamp (like: '.date('U').$sep.')',fol
//toegevoegd door Ben Bridts
	"B" =>	'ddhhmmss (like:'.date('dHis').$sep.')',
	);
...
echo '
	...
	<br/>
	<small>Prefix will follow the other rules, so if you choose dashes, it will use dashes. Meer mogelijkheden in code </small>
';
}
