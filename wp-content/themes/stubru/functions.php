...
/**
 * Toevoegen placeholder om menu in te zetten
 */
add_action('init', 'register_custom_menu');
 
function register_custom_menu() {
	register_nav_menu('sidebarmenu', __('Menu in Sidebar'));
}


/**
 * Registreren widget-areas, 1 in sidebar
 */
function stubru_widgets_init() {
	// Widget-plaats in de sidebar
  ...
  add_action( 'widgets_init', 'stubru_widgets_init' );