<?php
	...
	$stemmen = str_replace("\\", "", $stemmen);	
	}
	else {$output = '<div class="overzicht">
	Uw bent helaas te laat en kan niet meer stemmen.</div>';}
			...
			<div id="content">
				...
				else
				{
					...
					<div class="blokje">
						...
						<form name="nieuw" action="index.php" method="post">
							<fieldset>
								<label>Titel:</label><input type="text" name="title" />
								<label>Artiest:</label><input type="text" name="artist" />
						...
						foreach ($sugesties as $sug) 
						{
							?>
								<form method="post" action="index.php" class="blokje">
									...
									<p>
										<?php echo str_replace("\\", "", $sug->getArtist()); ?><br/>
										<span class="titel"><?php echo str_replace("\\", "", $sug->getTitle()); ?></span>
									</p>
